...
first_frame = Frame(root_var)  # First Frame
first_frame.pack(side=LEFT, padx=15)

# Creating the lyric box

lyrics_option_frame = Frame(first_frame)  # Creating a separate frame to store user interactive options such as search or remove lyrics
lyrics_option_frame.pack(side=BOTTOM)

singer_name = Label(lyrics_option_frame, text="Artist Name:")  # A label for the singer's name
singer_name.grid(row=0, column=0, pady=15, padx=15)

singer_name_input = Entry(lyrics_option_frame, background="lightgray")  # An entry to get singer's name
singer_name_input.grid(row=0, column=1, pady=15, padx=15)

singer_song = Label(lyrics_option_frame, text="Song Name:")  # A label for the singer's song's name
singer_song.grid(row=1, column=0, padx=15)

singer_song_input = Entry(lyrics_option_frame, background="lightgray")  # An entry to get singer's song's name
...
search = Button(lyrics_option_frame, text="Search Lyrics", command=show_lyrics)  # A button to show lyrics
...
remove = Button(lyrics_option_frame, text="Remove Lyrics", command=remove_lyrics)  # A button to remove lyrics
remove.grid(row=2, column=1, pady=25)

lyric_label = Label(first_frame, text="Enter the name of a song and it's artist to see it's lyrics")
lyric_label.pack(pady=15, padx=5)

lyric_box_scrollbar = Scrollbar(first_frame, orient=VERTICAL)
lyric_box = Text(first_frame, height=15, width=35, background="lightgray", bd=0, yscrollcommand=lyric_box_scrollbar.set)
...
third_frame = Frame(root_var)  # Third Frame
third_frame.pack(side=RIGHT, padx=15)

second_frame = Frame(root_var)  # Second Frame
...
playlist_box_scrollbar = Scrollbar(third_frame, orient=VERTICAL)  # Creating a scrollbar for the playlist
playlist_box = Listbox(third_frame, height=13, width=35, background="lightgray", bd=0, yscrollcommand=playlist_box_scrollbar.set)
...
playlist_label = Label(third_frame, text="Your playlist")
...
add_song_btn = Button(third_frame, image=add_song_icon, bd=0, command=select_file)  # A button to add songs to the list
...
del_song_btn = Button(third_frame, image=del_song_icon, bd=0, command=del_file)  # A button to delete songs from the list
...
rep_song_btn = Button(third_frame, image=rep_song_off_icon, bd=0, command=rep_song)  # A button to delete songs from the list
rep_song_btn.pack(pady=5)
...
middle_frame.pack(padx=25, pady=35)
...
bottom_frame = Frame(second_frame)  # Second Bottom Frame
bottom_frame.pack(pady=45)
